...
class UserAllBidsPage extends StatefulWidget {

  UserClass currentUser;
  UserAllBidsPage();
  UserAllBidsPage.init(this.currentUser);
  @override
  State<StatefulWidget> createState() {
    return new _UserAllBidsPage();
  }
}

class _UserAllBidsPage extends State<UserAllBidsPage> {
                        ...
                        onTap: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  UserSearchBidsPage.initFromCategoryUser(widget.currentUser, categories[position])),
                        ),
//                        child: Container(
//                          child: Center(
//                            child: Text(
